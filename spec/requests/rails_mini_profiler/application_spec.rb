  ...
  RSpec.describe 'Application', type: :request do
    ...
    describe 'POST /movie' do
      ...
      it 'saves performance data' do
        ...
        trace_end = trace.end.to_f * Tracers::Tracer::TIMESTAMP_MULTIPLIER
        expect(profiled_request.start).to be_within(10_000).of(trace_start)
        expect(profiled_request.finish).to be_within(10_000).of(trace_end)
